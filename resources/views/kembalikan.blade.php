        ...
        <div class="main-container">
            <div class="table-container mt-4">
                <table class="table table-hover">
                    ...
                    @forelse($bukuDipinjam as $index=>$item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{route('actionKembalikan')}}" onsubmit="return confirm('Apakah Anda yakin ingin mengembalikan buku ini?')" method="post">
                                @csrf
                                <input type="hidden" name="id_pinjam_buku" value="{{$item->id_pinjam_buku}}">
